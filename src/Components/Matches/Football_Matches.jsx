...
function Football_Matches() {
  ...
  const [drawt1, setdrawT1] = useState("0.0");
  const [drawt2, setdrawT2] = useState("0.0");
  ...
  const [odd4Stack, setOdd4Stack] = useState("0");
 ...
 if (sessionMarket == "Match Odds") {
        if (
          ...
          drawt1[0]?.price == dataValue ||
          drawt1[1]?.price == dataValue ||
          drawt1[2]?.price == dataValue ||
          drawt2[0]?.price == dataValue ||
          drawt2[1]?.price == dataValue ||
          drawt2[2]?.price == dataValue
        ) {
          if (back == "back") {
            try {
  ...
  const ProfitVauePageOdds = async () => {
    try {
      ...
      if(res[2] && counteyName[2]?.runnerName==res[2].team){
        console.log("ProfitVauePageOdd1",res[2].team)
         setOdd3Stack(res[2].amount)
      }
    }
                ...
                <div class="section_bg">
                  ...
                  <div className="">
                    <iframe
                      ...
                      src={`https://internal-consumer-apis.jmk888.com/go-score/template/1/${id}`}
                    ></iframe>
...
{odd3Stack !== 0 && (
  <span style={{ color: odd3Stack >= 0 ? "green" : "red" }}>
    {odd3Stack}
  </span>
)}
                                ...
                                {isNaN(drawt1[2]?.price) ? (
                                  ...
                                  <td className="td_width display">
                                    ...
                                    >
                                      <h4>{drawt1[2]?.price}</h4>
                                      {drawt1[2]?.size < 1000 ? (
                                        <p>{drawt1[2]?.size}</p>
                                      ) : (
                                        <p>
                                          {(drawt1[2]?.size / 1000).toFixed(
                                            1
                                          )}
                                          K
                                        </p>
                                ...
                                {isNaN(drawt1[1]?.price) ? (
                                  ...
                                  <td className="td_width display">
                                    ...
                                    >
                                      <h4>{drawt1[1]?.price}</h4>
                                      {drawt1[1]?.size < 1000 ? (
                                        <p>{drawt1[1]?.size}</p>
                                      ) : (
                                        <p>
                                          {(drawt1[1]?.size / 1000).toFixed(
                                            1
                                          )}
                                          K
                                        </p>
                                ...
                                {isNaN(drawt1[0]?.price) ? (
                                  ...
                                  <td className="td_width">
                                    ...
                                    >
                                      <h4>{drawt1[0]?.price}</h4>
                                      {drawt1[0]?.size < 1000 ? (
                                        <p>{drawt1[0]?.size}</p>
                                      ) : (
                                        <p>
                                          {(drawt1[0]?.size / 1000).toFixed(
                                            1
                                          )}
                                          K
                                        </p>
                                ...
                                {isNaN(drawt2[0]?.price) ? (
                                  ...
                                  <td className="td_width">
                                    ...
                                    >
                                      <h4>{drawt2[0]?.price}</h4>
                                      {drawt2[0]?.size < 1000 ? (
                                        <p>{drawt2[0]?.size}</p>
                                      ) : (
                                        <p>
                                          {(drawt2[0]?.size / 1000).toFixed(
                                            1
                                          )}
                                          K
                                        </p>
                                ...
                                {isNaN(drawt2[2]?.price) ? (
                                  ...
                                  <td className="td_width display">
                                    ...
                                    >
                                      <h4>{drawt2[2]?.price}</h4>
                                      {drawt2[2]?.size < 1000 ? (
                                        <p>{drawt2[2]?.size}</p>
                                      ) : (
                                        <p>
                                          {(drawt2[2]?.size / 1000).toFixed(
                                            1
                                          )}
                                          K
                                        </p>
                          ...
                          >
                            South Africa V Australia: Advance Toss , Fancy
                            And BM Odds Started in our Exchange 🏏
                          </marquee>
                        </div>
                      </div>
                    ) : (
