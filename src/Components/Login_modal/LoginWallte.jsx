...
// console.log("inputValue",inputValue);
  ...
  const Login_APi = async () => {
    try {
      ...
      let responce = await API.post("/login_WithWallet", {
        encryptedData: body,
      });
      responce = responce.data.data;
      console.log("MataRes", responce);
    ...
    <div className="Main_lgon_mdoal">
      ...
      >
        <Modal.Header className="login_headr">
          ...
          >
            <h4 className="Main_login_heading" >MLM Login</h4>
        ...
        {/* {inputValue === null && (
          <span id="metamaskConnections" style={{ color: 'red',textAlign:"center" }}>
        ...
        <Modal.Body className="conten_body">
          <div className="body_content_login">
            <div className="main_card_login">
              <label htmlFor="username">Wallet Address</label> <br />
              <input
                type="text"
